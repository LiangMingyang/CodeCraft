...
(function() {
  ...
  exports.getIndex = function(req, res) {
    ...
    currentUser = void 0;
    global.myUtils.getSolutionCount().then(function(Results) {
      return console.log(Results[1].dataValues.COUNT);
    });
    global.myUtils.getRankCount(void 0, void 0).then(function(Counts) {
      return console.log(Counts[1]);
    });
    return global.db.Promise.resolve().then(function() {
      ...
      return global.myUtils.getSolutionCount().then(function(Results) {
        return global.myUtils.getRankName0(Results).then(function(solcounts0) {
          return global.myUtils.getRankName1(Results).then(function(solcounts1) {
            return global.myUtils.getRankName2(Results).then(function(solcounts2) {
              return global.myUtils.getRankName3(Results).then(function(solcounts3) {
                return global.myUtils.getRankName4(Results).then(function(solcounts4) {
                  return global.myUtils.getRankName5(Results).then(function(solcounts5) {
                    return global.myUtils.getRankName6(Results).then(function(solcounts6) {
                      return global.myUtils.getRankName7(Results).then(function(solcounts7) {
                        return global.myUtils.getRankName8(Results).then(function(solcounts8) {
                          return global.myUtils.getRankName9(Results).then(function(solcounts9) {
