...
(function() {
  var GROUP_PAGE, HOME_PAGE, INDEX_PAGE, LOGIN_PAGE, PROBLEM_DIR, SUBMISSION_PAGE, SUBMIT_PAGE, fs, markdown, myUtils, path;
  ...
  exports.getIndex = function(req, res) {
    ...
    return Problem.find(req.param.problemID).then(function(problem) {
      ...
      return fs.readFile(path.join(myUtils.getStaticProblem(problem.id), 'manifest.json'), function(err, manifest_str) {
        ...
        return fs.readFile(path.join(PROBLEM_DIR, problem.id + '/' + manifest.description), function(err, description) {
          if (err) {
            throw new myUtils.Error.InvalidFile();
          }
