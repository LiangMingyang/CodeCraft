...
(function() {
  angular.module('west', ['ui.bootstrap', 'west-router']).controller('main', function($scope) {}).controller('top', function($scope, $timeout) {
    var update;
    $scope.now = new Date();
    update = function() {
      $scope.now = new Date();
